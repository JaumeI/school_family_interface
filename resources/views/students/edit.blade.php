                ...
                <div class="p-6 bg-white border-b border-gray-100">
                    ...
                    <form method="POST" action={{ route('users.store', ['id' => $user->id]) }}>
                        ...
                        <div class="md:columns-2">
                            <div class="mb-4">
                                <input type="checkbox" name="manage_users" value="manage_users" id="manage_users"
                            ...
                            <div class="mb-4">
                                <input type="checkbox" name="manage_students" value="manage_students"
                                       id="manage_students"
                            ...
                            <div class="mb-4">
                                <input type="checkbox" name="manage_groups" value="manage_groups" id="manage_groups"
                            ...
                            <div class="mb-4">
                                <input type="checkbox" name="manage_permissions" value="manage_permissions"
                            ...
                            <div class="mb-4">
                                <input type="checkbox" name="manage_tags" value="manage_tags" id="manage_tags"
                            ...
                            <div class="mb-4">
                                <input type="checkbox" name="upload_images" value="upload_images" id="upload_images"
                            ...
                            <div class="mb-4">
                                <input type="checkbox" name="see_images" value="see_images" id="see_images"
                            ...
                            <div class="mb-4">
                                <input type="checkbox" name="start_thread" value="start_thread" id="start_thread"
                            ...
                            <div class="mb-4">
                                <input type="checkbox" name="messages" value="messages" id="messages"
