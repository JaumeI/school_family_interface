                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    <tr class={{ $i%2==0? "bg-white" : "bg-indigo-50" }}>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <a href="{{ route('tags.edit', ['id' => $tag->id]) }}" class="text-indigo-600 hover:text-indigo-900"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
